...
namespace WindowsFormsApp2
{
    public partial class tratamientomedico : Form
    {
        ...
        private void bttguardar_Click(object sender, EventArgs e)
        {
            ...
            string Fotografias = txtfotografias.Text;
        ...
        private bool ValidarDatos()
        {
            ...
            if (string.IsNullOrEmpty(txtfotografias.Text.Trim()))
            {
                errorMensaje.SetError(txtfotografias, "Por favor ingrese las fotografias relacionadas del tratamiento");
                return false;
            }
        
            else
            {
                errorMensaje.SetError(txtfotografias, null);
